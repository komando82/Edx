...
import Lists from './Lists.js'; // eslint-disable-line 
import AddList from './AddList.js'; // eslint-disable-line 
import './App.css';
...
class App extends Component {
	...
	handleAddItem(s) {
		// Implement this function!
		this.state.items[s[0]].push({'name': s[1]});
